            ...
            <div className="rounded-sm border bordegrid bg-white p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div>
                    ...
                    <div className="mb-7.5 gap-3 border-b border-stroke pb-5 dark:border-strokedark leading-relaxed flex flex-row ">
                        ...
                        <div className="mb-7.5 gap-3 border-b border-stroke pb-5 dark:border-strokedark leading-relaxed flex flex-row flex-wrap ">
                            <div>
                                <CheckboxTwo id="checkbox01" value= ""/><b>Solution #1.</b> The fundraising activities participation should be included in the organization privacy practices note. <b>Reason #1.</b> The fundraising activities participation is not included in the organization privacy practices note. 
                            </div>
                            <div>
                                <CheckboxTwo id="checkbox01" value= ""/><b>New solution:</b>
                            </div><br/>
                            <div className="flex flex-wrap mb-2.5">
                                <input
                                    type="input"
