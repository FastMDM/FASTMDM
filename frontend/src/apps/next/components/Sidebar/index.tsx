...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden duration-300 ease-linear lg:static lg:translate-x-0 bg-white dark:bg-boxdark ${
      ...
      <div className=" flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/realestate" || pathname.includes("realestate")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/equipment" || pathname.includes("equipment")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/financial" || pathname.includes("financial")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/classifiers" || pathname.includes("classifiers")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="/classifiers"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 hover:text-white ${
                          (pathname === "/classifiers" ||
                            pathname.includes("classifiers")) &&
                          "bg-graydark dark:bg-meta-4 text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/diagnostics" || pathname.includes("diagnostics")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/teaching" || pathname.includes("teaching")
                }
              >
                {(handleClick, open) => {
                  return (
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/teaching"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-black dark:text-white duration-300 ease-in-out  ${
                                pathname.includes("teaching") && "bg-graydark dark:bg-meta-4 text-white"
                              }`}
                            >
                              Teaching
                            </Link>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/learning" || pathname.includes("learning")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/testing" || pathname.includes("testing")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/certification" || pathname.includes("certification")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <li>
                <Link
                  href="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 hover:text-white ${
                    pathname.includes("profile") && "bg-graydark dark:bg-meta-4 text-white"
                  }`}
                >
                  <svg
                    className="fill-current"
